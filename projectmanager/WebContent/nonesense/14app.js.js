                ...
                .then(function(response) {
								...
								console.log(response.data);
									...
									$scope.addNewHourReport = function (){
										...
										console.log("the project: " +userId +" "+$scope.project+" "+date+" "+$scope.startdate+" "+$scope.enddate+" "+$scope.description);
										$http.get("http://localhost/projectmanager/rest/hourreport/createHourReport?" +
												"employee="+userId+"&project="+$scope.project+"&date="+date+"&startdate="+$scope.startdate+"&enddate="+$scope.enddate+"&description="+$scope.description )
						                .then(function(response) {
						                		console.log(response.data);
										        $scope.Employee.push({
		...
		$http.get("http://localhost/projectmanager/rest/user/getuser?username="+$scope.username+"&password="+$scope.password)
				.then(function(response) {
                   ...
                   if (response.data.type == "e") {
                	    ...
                	    $("#secondtr").css("visibility", "visible");
